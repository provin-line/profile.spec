...
**→ 0.1 タグ条件はすべて充足。** 2026-07-27、public 化と同日に `v0.1.0` を
タグ（切るかどうかを public 化の判断と併せる、としていた最後の一点が解けた）。
条件 1〜3 はタグ時点で台帳を信用せず再検証している（10 rule すべて `draft`、
全 rule に vector、`tools/lint.py` green）。
